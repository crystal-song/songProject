    ...
    <div class="user_right">
     <table  bgcolor="#eee" border="0" cellpadding="0" cellspacing="1" class="quan_tab">
                ...
                <tr>
                    ...
                    <td bgcolor="#FFFFFF"><a href="<%=path%>/gate/doRepayment?id=${productrepay.id }&total=${total}" onclick="checkAvaliMoney();">立即还款</a></td>
                    </c:if>
                    <td bgcolor="#FFFFFF"></td>
                </tr>
            </table>
...
<script type="text/javascript">
	function checkAvaliMoney(){
		$.ajax({
			url:"/loan/checkAvaliMoney?total="+$("#total").val(),
