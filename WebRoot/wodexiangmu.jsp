    ...
    <div class="user_right">  
        <div class="zichan_con">        
          ...
          <div class="con_list">
				...
				<thead>
				<tr>
				<td align="center" height="40">项目名称</td><td align="center">投资金额</td><td align="center">投资时间</td><td align="center">到期时间</td><td align="center">预期收益</td><td align="center">查看协议</td>
				</tr>
				</thead>
            ...
            <c:forEach var="s" items="${li}" varStatus="i">
				...
				<tr>
				<td align="center"  height="30">${s.projectName}</td><td align="center">${s.paymentAmount}</td><td align="center">${s.projectName}</td><td align="center">${s.transDate}</td><td align="center">${s.paymentAmount * s.interestRate}</td><td align="center"> <a href="<%=path%>/gate/authorization?platformUserNo=${s.platformUserNo}&enterpriseNumber=${s.enterpriseNumber}&transDate=${s.transDate}">查看</a></td>
				</tr>
