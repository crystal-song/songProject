...
<link  href="<%=path%>/static/css/jquery.fullPage.css" rel="stylesheet" type="text/css" />
<style type="text/css">
.section { text-align: center; font: 50px "Microsoft Yahei"; color: #fff; position:relative;}
.sec1{background:url(<%=path%>/static/images/shouye.jpg) no-repeat 50%; background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec2{background:url(<%=path%>/static/images/pic4.jpg) no-repeat 50%; background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec3{background:url(<%=path%>/static/images/pic2.jpg) no-repeat 50%;  background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec4{background:url(<%=path%>/static/images/aa.jpg) no-repeat 50%;  background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec5{background:url(<%=path%>/static/images/pic1.jpg) no-repeat 50%; background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec6{background:url(<%=path%>/static/images/pic6.jpg) no-repeat 50%;  background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
</style>

<script src="<%=path%>/static/js/jquery-1.8.3.min.js"></script>
<script src="<%=path%>/static/js/jquery-ui-1.10.3.min.js"></script>
<script src="<%=path%>/static/js/jquery.fullPage.min.js"></script>
