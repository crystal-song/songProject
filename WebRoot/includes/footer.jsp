...
<div class="footer">
     <ul>
       <li class="foo01"><strong>合作伙伴</strong>
         <ul>
           <li><img src="/img/images-2014-11/hezuo01.png" width="180" height="80" /></li>
           <li><img src="/img/images-2014-11/hezuo02.png" width="180" height="80" /></li>
           <li><img src="/img/images-2014-11/hezuo03.png" width="180" height="80" /></li>
           <li><img src="/img/images-2014-11/hezuo04.png" width="250" height="80" /></li>
         </ul>
       ...
       <li>
         <ul class="min_label">
          <li class="min_mar"><a href="/help_con.jsp">关于我们</a></li>
          <li><a href="/question.jsp">常见问题</a></li>
          <li><a href="/security.jsp">安全策略</a></li>
          <li><a href="/notice.jsp">法律声明</a></li>
          <li><a href="/jiaruwomen.jsp">加入我们</a></li>
