...
<div class="news_location">当前位置：<a href="<%=path%>/" >首页</a> >> <a href="<%=path%>/help_con.jsp">帮助中心</a> >> <a href="<%=path%>/help_con.jsp" >关于我们</a></div>
   <div class="user_con_news">
       ...
       <div class="right_news_con"> 
          ...
          <p>中租宝开创了P2B的2.0新时代，首次提出高标准、严要求挑选合作伙伴，只接受优质担保机构（信用评级A+级以上，政府重点扶持项目）企业的银行级理财项目，并有专家风控团队，为投资者提供100%本息保障，最高超过银行活期同期存款30倍的高收益理财项目。通过中租宝，您可以将手中富余资金出借给盈利能力强的中小企业，并获得高收益的利息回报，分享企业高速发展的红利。 </p> 
          <p>
                       中投汇融投资管理有限公司（以下简称“中投汇融”）
                       是国内首批P2B（微信托） 领域的财富投资管理公司。我们汇集了一批国内一线信托公司的精英骨干， 立志在这个全民理财时代，创造一个“公正透明，稳定高效”的财富管理平台。          
           </p>         
