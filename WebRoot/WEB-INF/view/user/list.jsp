...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('body').layout('panel', 'center').panel('panel').find(
				'div.panel-header').addClass('customHeader1');
		$('body').layout('panel', 'center').panel('panel').find(
				'div.panel-title').addClass('tittle1');
		$('#deptCombo').combogrid({
			idField : 'id', //ID字段
...
<body>
	<form id="queryForm" style="margin: 10;">
		<table width="50%">
			<tr>
				<td><span class="mc">名字：</span><input name="name" style="width: 200px; border:1px #a4bed4 solid;"></td>
				<td><span class="mc">部门：</span><input id="deptCombo" name="deptId" style="width: 200px; border:1px #a4bed4 solid;"></td>
