          ...
          <div class="pro_list">
               <div class="con_list">
                  <ul>
                    <li>
                      <div class="floor_num01">
                         <a class="floor_img01"><img src="<%=path%>/img/images-2014-11/pro_pic02.jpg" width="250" height="150" />
                   
                         <div class="last_time01">剩余时间:<strong>&nbsp;&nbsp;28</strong>天</div>
                         </a>
                         <a class="shuoming01">Withings智能无线血压仪——随时随地关爱健康,光耀集团欢迎您的加入。</a>
                         <div class="aim01">
                           <span style="color:#a4a4a4;">目标:</span>
                           <span>60天</span>
                           <span><em>¥&nbsp;&nbsp;</em>60000</span>
                           <a>融资中</a>
                         </div>
                         <div class="loding_bar">
                         <div class="l_b"></div>
                         ...
                         <div class="floor_bottom01">
                           <span><a class="baifenbi01" style="float:left; text-align:left;">71%</a>
                           <a style="float:left; color:#a4a4a4;">已达</a></span>
                           <span><a class="baifenbi01"><em>¥&nbsp;&nbsp;</em>30000</a><a style="color:#a4a4a4;">已筹资
                           </a>
                           </span>
                           <span><a class="baifenbi01" style="float:right; text-align:right;">25<em>天</em></a>
                           <a style="float:right; color:#a4a4a4;">剩余时间</a></span>
                         </div>
                         <div class="botm_btn01">
                          <a href="#" class="btn_org wid">查看近期动向</a>
                         </div>
                    </div> 
                  </li>
                  <li>
                      <div class="floor_num01">
                         <a class="floor_img01"><img src="images/pro_pic02.jpg" width="250" height="150" />
