...
<link  href="<%=path%>/zhuanti/201412newpro/css/style.css" rel="stylesheet" type="text/css" />
<link  href="<%=path%>/zhuanti/201412newpro/css/jquery.fullPage.css" rel="stylesheet" type="text/css" />
<style type="text/css">
.section { text-align: center; font: 50px "Microsoft Yahei"; color: #fff; position:relative;}
.sec1{background:url(<%=path%>/zhuanti/201412newpro/images/shouye.jpg) no-repeat 50%; background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec2{background:url(<%=path%>/zhuanti/201412newpro/images/pic4.jpg) no-repeat 50%; background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec3{background:url(<%=path%>/zhuanti/201412newpro/images/pic2.jpg) no-repeat 50%;  background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec4{background:url(<%=path%>/zhuanti/201412newpro/images/aa.jpg) no-repeat 50%;  background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec5{background:url(<%=path%>/zhuanti/201412newpro/images/pic1.jpg) no-repeat 50%; background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
.sec6{background:url(<%=path%>/zhuanti/201412newpro/images/pic6.jpg) no-repeat 50%;  background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;}
</style>

<script src="<%=path%>/zhuanti/201412newpro/js/jquery-1.8.3.min.js"></script>
<script src="<%=path%>/zhuanti/201412newpro/js/jquery-ui-1.10.3.min.js"></script>
<script src="<%=path%>/zhuanti/201412newpro/js/jquery.fullPage.min.js"></script>
...
<div id="header"><span></span><a href="#" class="shouyelink">进入首页</a></div>
    ...
    <div id="staticImg">
		<div class="imgsContainer">
			...
			<img src="<%=path %>/zhuanti/201412newpro/images/500_fang.gif" />
		</div>
   </div> 
</div>
...
>>>>>>> b722f4b275d53c63c17a73e4b2ad46c27db3a79f
