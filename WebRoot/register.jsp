				...
				<div class="user_con01">
					<div class="container">
						<form id="form" role="form" action="<%=path%>/gate/doRegister"
							...
							<div class="jin_input " style="padding-left:300px;">
								<input type="submit" name="submibtn" id="mysubmit_btn" class="input_jinbtn" value="立即注册" onclick="onSubmit('${f.onSubmit}')" ></input>
							</div>
