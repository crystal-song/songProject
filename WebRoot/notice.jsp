...
<div class="frame">
<div class="news_location">当前位置：<a href="<%=path%>/index.jsp" >首页</a> >> <a href="<%=path%>/help.jsp" >帮助中心</a> >> <a href="<%=path%>/notice.jsp" >法律声明</a></div>
<!-- left menu -->
    ...
    <div class="bz_right">
        ...
        <div class="bzr_nr">
        	<dl>
               ...
               <p>3.适用法律</p>
               <dd>网站（http://www.ptobchina.com/）由中汇宝运营和控制，适用中华人民共和国法律。我们保留随时更改我们的网站和上述免责及条款的权利。
        	   </dd>
        	</dl>
