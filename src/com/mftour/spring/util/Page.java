...
public class Page {
   ...
   * @return
   */
  public static Page newBuilder(int pageNo, int pageSize, String url, Object obj){
	    Page page = Page.newBuilder(pageNo, pageSize, url);
	    page.getParams().putAll(MapUtil.convertObjToStringMap(obj));
	    return page;
  }
