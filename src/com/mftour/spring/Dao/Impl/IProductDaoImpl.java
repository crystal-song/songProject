...
public class IProductDaoImpl  extends HibernateDaoSupport  implements  IProductDao {
	...
	public List<TProduct> getProduct(Page page,TProduct product) throws Exception {
		...
		if (product != null) {
			...
			if (product.getFinancingPeriod() !=null && product.getFinancingPeriod()!=1){
				// sb.append(" and user.name like :userName");
				// params.put("userName", "%"+user.getName()+"%");
			...
			if (product.getFinancingMoney()!=null && product.getFinancingMoney()!=1) {
				  /* int FinancingMoney1=200;
				   int FinancingMoney2=500;
				   int FinancingMoney3=1000;*/
			...
			if (product.getFinancingProgress() != null && product.getFinancingProgress() !=1) {
              ...
              if (product.getProjectStatus() != null && product.getProjectStatus() !=1) {
