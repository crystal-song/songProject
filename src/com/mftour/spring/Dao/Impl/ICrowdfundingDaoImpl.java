...
public class ICrowdfundingDaoImpl extends HibernateDaoSupport implements
	...
	public List<TCrowdfunding> getCrowdfunding(Page page,
		 ...
		 * 
		 * 
		 * if(product.getYearIncome() !=null && product.getYearIncome()!=1){ int
		 * YearIncome1=10; int YearIncome2=15; int YearIncome3=20;
		 * 
		 * 
		 * 
		 * // sb.append(" and user.name like :userName"); //
		 * params.put("userName", "%"+user.getName()+"%"); if (params.size() >
		 * 0) { sb.append(" and"); } else { sb.append(" where"); }
		 * 
		 ...
		 * 
		 * sb.append(
		 * " product.yearIncome >= :YearIncome1 and product.yearIncome < :YearIncome2 "
		 * ); params.put("YearIncome1", YearIncome1); params.put("YearIncome2",
		 * YearIncome2); } if(product.getYearIncome()==20){
		 * 
		 * sb.append(
		 * " product.yearIncome >= :YearIncome2 and product.yearIncome < :YearIncome3 "
		 * ); params.put("YearIncome2", YearIncome2); params.put("YearIncome3",
		 * YearIncome3); }
		 * 
		 * }
		 * 
