...
public class guaranteeController {
	...
	@RequestMapping(value = "/getchannel", method = { RequestMethod.POST,
			RequestMethod.GET })
	public String getchannel(Model model) throws Exception {
	...
	@RequestMapping(value = "/getlist", method = { RequestMethod.POST,
			RequestMethod.GET })
	public String getlist(Model model, TChannel channel) throws Exception {
	...
	@RequestMapping(value = "/getTNewsById", method = { RequestMethod.POST,
			RequestMethod.GET })
	public String getTNewsById(Model model, TNews news) throws Exception {
	...
	@RequestMapping(value = "/getNewslist", method = { RequestMethod.POST,
			RequestMethod.GET })
	public String getNewslist(Model model, TNews news) throws Exception {
