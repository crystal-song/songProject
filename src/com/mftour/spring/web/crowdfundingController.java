...
public class crowdfundingController {
	...
	@RequestMapping(value = "/allCrowdfunding", method = { RequestMethod.POST,
			RequestMethod.GET })
	public String allProduct(
			@RequestParam(value = "pageNo", required = false, defaultValue = "1") int pageNo,
			@RequestParam(value = "pageSize", required = false, defaultValue = "2") int pageSize,
			@RequestParam(value = "name", required = false, defaultValue = "") String name,
			Model model, TCrowdfunding crowdfunding) throws Exception {
	...
	@RequestMapping(value = "/getCrowdfundingByid", method = {
			RequestMethod.POST, RequestMethod.GET })
	public String getProductByid(@RequestParam("id") Long id, Model model,
			TCrowdfunding crowdfunding) throws Exception {

		TCrowdfunding crowdfunding1 = crowdfundingService
				.getCrowdfundingById(id);

		List<TCrowdfundingCommodity> list = crowdfundingService
				.queryTCrowdfundingCommodityByNumber(crowdfunding1
						.getProjectNumber());
